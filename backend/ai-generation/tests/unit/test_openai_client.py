...
class TestOpenAIClient:
    ...
    @respx.mock
    def test_generate_image_from_prompt_success(
        self, client: OpenAIClient, respx_mock: MockRouter
    ) -> None:
        ...
        result = client.generate_image_from_prompt(
            prompt="SARAH", size="1024x1024", quality="standard"
        )
    ...
    @respx.mock
    def test_generate_image_rate_limit_error(
        self, client: OpenAIClient, respx_mock: MockRouter
    ) -> None:
        ...
        with pytest.raises(RateLimitError) as exc_info:
            client.generate_image_from_prompt(
                prompt="SARAH", size="1024x1024", quality="standard"
            )
    ...
    @respx.mock
    def test_generate_image_authentication_error(
        self, client: OpenAIClient, respx_mock: MockRouter
    ) -> None:
    ...
    @respx.mock
    def test_generate_image_service_error(
        self, client: OpenAIClient, respx_mock: MockRouter
    ) -> None:
    ...
    @respx.mock
    def test_generate_image_retry_logic(
        self, client: OpenAIClient, respx_mock: MockRouter
    ) -> None:
    ...
    @respx.mock
    def test_generate_image_max_retries_exceeded(
        self, client: OpenAIClient, respx_mock: MockRouter
    ) -> None:
